...
@section('content')
    ...
    <div class="container-fluid col-md-10 my-5 pt-4">
        ...
        <!-- SECTION 3 CARACTERISTIQUE VEHICULE
        ========================================================== -->
        <div class="row mt-5">
        ...
        <div class="row mt-5" id="section_show_5">
            ...
            <!-- SI AVIS VEHICULE BOUCLE SUR AVIS --> 
            @if ($avis->count() > 0)
